  ...
  ({ style, className, onClick, direction, show = true }, ref) => {
    return (
      <button
        ...
        onClick={onClick}
        className={clsx(
          "transition-all duration-300 ease-in-out text-center min-w-[32px] w-[6%] bg-[rgba(0,0,0,.7)] text-white text-2xl absolute top-0 right-0 h-full z-[999] opacity-70 hover:opacity-100",
          {
